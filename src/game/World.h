...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_TRANSMOG_ITEM_POOR,
    CONFIG_BOOL_TRANSMOG_ITEM_NORMAL,
    CONFIG_BOOL_TRANSMOG_ITEM_UNCOMMON,
    CONFIG_BOOL_TRANSMOG_ITEM_RARE,
    CONFIG_BOOL_TRANSMOG_ITEM_EPIC,
    CONFIG_BOOL_TRANSMOG_ITEM_LEGENDARY,
    CONFIG_BOOL_TRANSMOG_ITEM_ARTIFACT,
    CONFIG_BOOL_TRANSMOG_ITEM_HEIRLOOM,
